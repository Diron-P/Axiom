...
namespace Axiom 
{
	namespace Math 
	{
		...
		public:
			...
			Matrix4(const Vector4& vx, const Vector4& vy, const Vector4& vz, const Vector4& vw);

			/*************************************************************
			//	MATRIX OPERATOR DECLARATIONS
			*************************************************************/
			friend Matrix4& operator*=(const Matrix4& m, const Matrix4& m1);
			...
			friend bool operator==(const Matrix4& m, const Matrix4& m1);
			friend bool operator!=(const Matrix4& m, const Matrix4& m1);
		...
		Matrix4::Matrix4(const float& num1, const float& num2, const float& num3, const float& num4, const float& num5, const float& num6, const float& num7, const float& num8, 
			const float& num9, const float& num10, const float& num11, const float& num12, const float& num13, const float& num14, const float& num15, const float& num16)
		{
			m[0][0] = num1;
			m[0][1] = num2;
			m[0][2] = num3;
		...
		Matrix4::Matrix4(const Vector4& vx, const Vector4& vy, const Vector4& vz, const Vector4& vw)
		{
			m[0][0] = vx.x;
			m[0][1] = vx.y;
			m[0][2] = vx.z;
		...
		Matrix4& operator*=(Matrix4& m, const Matrix4& m1)
		{
			// Row 1
		...
		inline Matrix4& Matrix4::MakeZero()
		{
			memset(m, 0, sizeof(m[0][0]) * 4 * 4);
			return *this;
		}
		...
		inline Matrix4& Matrix4::SetTranslation(const Vector3& v)
		{
			m[3][0] = v.x;
			m[3][1] = v.y;
			m[3][2] = v.z;
		...
		inline const Vector3& Matrix4::GetTranslation(void) const
		{
